...
import { MOCK_ACTIVITIES, MOCK_LEADS } from '@/lib/mock-data';
import { generateWhatsAppLink, formatPriceInLakhs } from '@/lib/formatters';
import { Calendar, PhoneCall, MessageSquare, CheckCircle, Clock, ExternalLink, Flame, ShieldCheck } from 'lucide-react';

export function ActivityFeed() {
  const hotLeads = MOCK_LEADS.filter((l) => l.stage === 'NEGOTIATION' || l.stage === 'TOKEN_PAID');
