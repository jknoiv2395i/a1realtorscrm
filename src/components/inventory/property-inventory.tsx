      ...
      {filteredProperties.length > 0 ? (
        ...
        <div className="p-12 text-center border border-dashed border-slate-800 rounded-2xl bg-slateDark-900/50 space-y-4">
          ...
          <div className="max-w-md mx-auto">
            <h3 className="text-base font-bold text-slate-200">No property mandates listed yet</h3>
            <p className="text-xs text-slate-400 mt-1">
              Click &apos;+ Add Property&apos; to create your first RERA verified residential or commercial listing.
            </p>
          </div>
          <button
            onClick={() => setIsAddPropertyOpen(true)}
